function renderUrlParser(el) {
  ...
  // Init build tab with 2 empty rows
  urlBuildAddRow();
  urlBuildAddRow();
}
...
/* ═══════════════════════════════════════════════════════
   Tab 1: URL Parse (existing functions preserved)
   ═══════════════════════════════════════════════════════ */
...
// Legacy encode/decode functions (backward compat, also usable standalone)
function urlEncode() {
...
/* ═══════════════════════════════════════════════════════
   Tab 2: Encode/Decode (from url-encode.js)
   ═══════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════
   Backward compat: renderUrlEncode points to same render
   ═══════════════════════════════════════════════════════ */
