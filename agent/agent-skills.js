...
// ── Skills 体系 ───────────────────────────────────────────────────
// Skill = 预定义的多步骤 Agent 工作流
// 用户触发关键词 → 自动构建 prompt → AgentSession 执行
...
const SKILLS = [
  ...
  },
  {
    ...
    name: '数据转换',
    icon: '🔄',
    triggers: ['转换','transform','处理','convert','编码解码'],
  ...
  },
  {
    ...
    name: '开发工具箱',
    icon: '🧰',
    triggers: ['开发工具','dev tools','生成','generate','工具箱'],
  ...
  },
  {
    ...
    name: '文本分析',
    icon: '📊',
    triggers: ['分析文本','analyze','统计','文本信息','字数'],
  ...
  },
  {
    ...
    name: '网络信息',
    icon: '🌐',
    triggers: ['网络','network','IP','子网','CIDR','域名'],
